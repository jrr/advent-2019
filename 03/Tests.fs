...
[<Fact>]
let ``problem`` () =
    solve problemInput |> should equal 225
    
[<Fact>]
let ``wire length test case 0`` () =
    let input = """R8,U5,L5,D3
U7,R6,D4,L4"""
    solve2 input |> should equal 30
    
[<Fact>]
let ``wire length test case 1`` () =
    let input = """R75,D30,R83,U83,L12,D49,R71,U7,L72
U62,R66,U55,R34,D71,R55,D58,R83"""
    solve2 input |> should equal 610
 
[<Fact>]
let ``wire length test case 2`` () =
    let input = """R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51
U98,R91,D20,R16,D67,R40,U7,R15,U6,R7"""
    solve2 input |> should equal 410
    
[<Fact>]
let ``wire length problem`` () =
    solve2 problemInput |> should equal 35194
